...
import { Compass, Star, Map, MessageCircle, Sparkles, ArrowRight, Check, Target, TrendingUp, Heart, Workflow, Shield, Code, Linkedin, Twitter, Github, Mail } from 'lucide-react';
import { ImageWithFallback } from './figma/ImageWithFallback';
import teamLeadImage from 'figma:asset/5fc1c91d532ed8327a51913627755ef8443b2b88.png';
import aiEngineerImage from 'figma:asset/ad3fda8282e7e85c71a9be5e2a628c9297c983e7.png';
import frontendEngineerImage from 'figma:asset/37523d906f50997b8bae4315c9f85ec1060d318a.png';
import backendEngineerImage from 'figma:asset/5f763c5748e26a81956b18095483cfe574f86a78.png';
      ...
      <section className="relative z-10 px-8 py-12 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-8 md:pl-6">
          ...
          <h1 className="text-6xl leading-tight">
            <span className="text-slate-800">Stop Managing Tasks.</span><br />
          ...
          <p className="text-xl text-slate-600 leading-relaxed">
            Compass is the AI Co-Pilot that turns your biggest ambitions into an interactive, step-by-step Quest.
          </p>
      ...
      <section className="relative z-10 px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Most people fail to achieve their goals not because they lack ability, but because they lack a system.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-600">
                  The "Blank Page" syndrome makes starting impossible. Where do you even begin?
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Traditional tools like linear to-do lists don't reflect the complexity of real life. They break under pressure.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Managing goals alone leads to motivation burnout. You need a partner in the journey.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-50/80 to-blue-50/80 backdrop-blur-sm rounded-2xl p-8 border border-cyan-200 shadow-xl">
            <h3 className="text-2xl mb-4 text-slate-800">The Compass Solution</h3>
            <p className="text-slate-600 mb-6">
              Compass replaces rigid lists with a <span className="text-cyan-600">Conversational AI Partner</span>.
            </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-600">
                  You speak naturally, and Compass breaks your goal into a visual roadmap using Generative AI.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Switch between a linear "Journey Map" and a holistic "Goalscape" view to see exactly where you stand.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Life happens. Compass proactively re-plans based on your energy and available resources.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative z-10 px-8 py-12">
        <div className="text-center mb-6">
          <div className="inline-block px-4 py-2 bg-indigo-50/80 backdrop-blur-sm rounded-full mb-4 border border-indigo-100">
            <span className="text-sm text-indigo-600">🔍 Under the Hood: How We Use AI</span>
          </div>
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-6">
            Unlike apps that just use AI for text, we use AI to <span className="text-slate-800">structure data</span>. Our system converts natural language into a hierarchical goal tree, creates Resource Scores, and dynamically prioritizes your work.
          </p>
          <div className="inline-block px-4 py-2 bg-emerald-50/80 backdrop-blur-sm rounded-full border border-emerald-100">
            <span className="text-sm text-emerald-600">✅ Prototype Status: Design & Interactive UI Ready</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto mt-12">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-indigo-100 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl mb-3 text-slate-800">Chat-to-JSON Goal Generation</h3>
            <p className="text-slate-600 mb-4">
              You describe your dream. Our LLM converts natural language into a hierarchical goal tree with sub-goals and actionable tasks. Each node has estimated time, energy, and resource requirements.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-cyan-50 text-cyan-700 rounded-full text-sm border border-cyan-100">LLM Integration</span>
              <span className="px-3 py-1 bg-cyan-50 text-cyan-700 rounded-full text-sm border border-cyan-100">Prompt Engineering</span>
              <span className="px-3 py-1 bg-cyan-50 text-cyan-700 rounded-full text-sm border border-cyan-100">JSON Structuring</span>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-indigo-100 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl mb-3 text-slate-800">Interactive Quest Visualization</h3>
            <p className="text-slate-600 mb-4">
              Switch between a linear "Journey Map" and a holistic "Goalscape" view powered by D3.js. See your progress, dependencies, and milestones at a glance. Every interaction is smooth and responsive.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-sm border border-emerald-100">D3.js Visualization</span>
              <span className="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-sm border border-emerald-100">Interactive Maps</span>
              <span className="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-sm border border-emerald-100">Dynamic Rendering</span>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-indigo-100 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl mb-3 text-slate-800">Dynamic Re-planning Engine</h3>
            <p className="text-slate-600 mb-4">
              Compass continuously monitors your energy, available resources, and calendar. When life changes, your plan adapts automatically. No rigid schedules—just fluid, intelligent guidance.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-sm border border-indigo-100">Resource Scoring</span>
              <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-sm border border-indigo-100">Real-time Signals</span>
              <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-sm border border-indigo-100">Adaptive Logic</span>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-indigo-100 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600 mb-4">
              Built with React/Next.js for responsive UI, D3.js for stunning visualizations, and integrated LLM APIs for intelligent goal decomposition. Scalable, maintainable, production-ready.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-teal-50 text-teal-700 rounded-full text-sm border border-teal-100">React/Next.js</span>
              <span className="px-3 py-1 bg-teal-50 text-teal-700 rounded-full text-sm border border-teal-100">D3.js</span>
              <span className="px-3 py-1 bg-teal-50 text-teal-700 rounded-full text-sm border border-teal-100">LLM APIs</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              We're currently in the prototype phase with design and clickable UI complete. Here's our path to launch and beyond.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="relative group">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border-2 border-indigo-200/60 shadow-xl hover:shadow-2xl transition-all duration-300 h-full">
                  <div className="flex items-start justify-between mb-6">
                    <h3 className="text-sm text-slate-500 leading-tight pr-2">Phase 1: Concept & Prototype (Current)</h3>
                    <span className="px-3 py-1 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full text-xs whitespace-nowrap shadow-md">Active</span>
                  </div>
                  
                  <h4 className="text-3xl mb-6 text-slate-800">Current Status</h4>
                  
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-indigo-400 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Market Research & Problem Definition</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-indigo-400 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">UI/UX Design in Figma (Quest Map & Dashboard)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-indigo-400 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Core AI Prompt Engineering (Goal Decomposition Logic)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-indigo-400 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Clickable Web App Development</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-2xl transition-all duration-300 h-full">
                  <div className="flex items-start justify-between mb-6">
                    <h3 className="text-sm text-slate-500 leading-tight pr-2">Phase 2: MVP Development</h3>
                    <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs whitespace-nowrap">Planned</span>
                  </div>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-slate-700 leading-snug">Implement Chat-to-JSON Goal Generation</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Build the Interactive "Quest Map" (Roadmap view)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Backend integration with LLM APIs</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Initial testing with early beta users</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-2xl transition-all duration-300 h-full">
                  <div className="flex items-start justify-between mb-6">
                    <h3 className="text-sm text-slate-500 leading-tight pr-2">Phase 3: Advanced Features</h3>
                    <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs whitespace-nowrap">Planned</span>
                  </div>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Implement "Goalscape" (Sunburst) View</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Develop "Resource Gauge" logic (Energy/Time analysis)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Dynamic re-planning engine</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Beta Testing with 50 users</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-2xl transition-all duration-300 h-full">
                  <div className="flex items-start justify-between mb-6">
                    <h3 className="text-sm text-slate-500 leading-tight pr-2">Phase 4: Launch</h3>
                    <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs whitespace-nowrap">Planned</span>
                  </div>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Public Release & Marketing campaign</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Mobile App adaptation</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Community building & feedback loops</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 flex-shrink-0 mt-1"></div>
                      <span className="text-slate-700 leading-snug">Continuous feature iteration</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              We combine deep technical expertise in fullstack development and AI engineering with a passion for product design and user psychology. Every role is essential. Every perspective matters.
            </p>
          </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 mb-4 leading-relaxed">
                    Leads the overall product strategy and vision. Handles full-stack development, ensuring seamless integration between frontend UI and backend systems. Manages technical roadmap execution.
                  </p>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 mb-4 leading-relaxed">
                    Specializes in engineering robust LLM workflows for goal decomposition. Designs the core logic that converts natural language into structured goal hierarchies. Integrates LLM APIs for maximum performance.
                  </p>
                  <div className="flex gap-3">
                    <a 
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 mb-4 leading-relaxed">
                    Builds robust APIs and manages scalable database architecture. Ensures data integrity, security, and performance. Handles infrastructure and deployment pipelines.
                  </p>
                  <div className="flex gap-3">
                    <a 
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-indigo-100/60 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-indigo-600 mb-4">
                    UI/UX Design, Figma Prototyping, and Client-side Implementation
                  </p>
                  <p className="text-slate-600 mb-4 leading-relaxed">
                    Designs and builds the interactive user interface. Creates stunning visualizations using D3.js. Brings the Quest Map and Goalscape to life with responsive, delightful interactions.
                  </p>
                  <div className="flex gap-3">
                    <a 
          ...
          <div className="grid md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-4">
              ...
              <p className="text-slate-400 leading-relaxed mb-6 max-w-sm">
                Transforming how humans navigate their daily lives through intelligent, adaptive productivity technology.
              </p>
              {/* Social Icons */}
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 backdrop-blur-sm border border-white/10 hover:border-indigo-400/50">
